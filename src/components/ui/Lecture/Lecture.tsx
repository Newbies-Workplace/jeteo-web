...
const Lecture: React.FC<LectureProps> = ({
  ...
  return (
    <div style={ status?.color ? {backgroundColor: status?.color} : {backgroundColor: "transparent", boxShadow: 'none'}} className={styles.boxBorder}>
      <div className={styles.lectureContainer}>
        <div className={styles.userContainer}>
          {speaker.avatar !== undefined && speaker.avatar !== null ? <img src={speaker.avatar} className={styles.userIcon} /> : <ProfilePic className={styles.userIcon}/>}
